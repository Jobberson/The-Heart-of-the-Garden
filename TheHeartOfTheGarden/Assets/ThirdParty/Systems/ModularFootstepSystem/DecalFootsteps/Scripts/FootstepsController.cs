namespace ModularFootstepSystem
{
    ...
    public class FootstepsController : MonoBehaviour
    {
        ...
        [SerializeField]
        protected List<FootHandler> footstepStartHandlers = new();
        [SerializeField]
        protected List<FootHandler> footstepMiddleHandlers = new();
        [SerializeField]
        protected List<FootHandler> footstepEndHandlers = new();
