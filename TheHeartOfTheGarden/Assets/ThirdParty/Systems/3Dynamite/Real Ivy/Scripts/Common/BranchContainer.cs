...
namespace Dynamite3D.RealIvy
{
    ...
    public class BranchContainer : ScriptableObject
    {
        ...
        public void UpdateLeavesDictEntry(int initSegmentIdx, LeafPoint leaf)
        {
            ...
            {
                List<LeafPoint> newEntryLeaves = new();
        ...
        {
            BranchPoint newBranchPoint = new(point, grabVector,
        ...
        public BranchPoint InsertBranchPoint(Vector3 point, Vector3 grabVector, int index)
        {
            ...
            BranchPoint newBranchPoint = new(point, grabVector, index, newPointLength, this);
        ...
        public void RemoveBranchPoint(int indexToRemove)
        {
            ...
            for (int i = indexToRemove + 1; i < branchPoints.Count; i++)
            {
                ...
                List<LeafPoint> modifiedLeaves = new();
        ...
        {
            List<LeafPoint> removedLeaves = new();
        ...
        {
            LeafPoint newLeaf = new(leafPoint, lpLength, lpForward, lpUpward, chosenLeave, initSegment, endSegment);
            leaves.Add(newLeaf);
            return newLeaf;
        }
