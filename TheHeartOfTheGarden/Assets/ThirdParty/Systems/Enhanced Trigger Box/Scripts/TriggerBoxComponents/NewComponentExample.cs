...
namespace EnhancedTriggerbox.Component
{
        ...
        : ConditionComponent // REPLACE THIS!!!
    {
        ...
        public override void DrawInspectorGUI()
        {
            ...
            checkIfActive = EditorGUILayout.Toggle(checkIfActive ? new GUIContent("Check If Active",
                "If true this condition will return true if the target gameobject is active. If false it will return true if the target gameobject is inactive.") 
                : new GUIContent("Check If Inactive",
                "If true this condition will return true if the target gameobject is active. If false it will return true if the target gameobject is inactive."), checkIfActive);

            TargetGameobject = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Example Game Object",
                    "Example tooltip"), TargetGameobject, typeof(GameObject), true);
        ...
        public override bool ExecuteAction()
        {
             ...
             *   return true;
             */
            return checkIfActive ? TargetGameobject.activeSelf : !TargetGameobject.activeSelf;
