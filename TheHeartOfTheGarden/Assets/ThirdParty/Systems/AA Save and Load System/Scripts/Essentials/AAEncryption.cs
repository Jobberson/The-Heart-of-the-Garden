...
namespace AASave
{
    public static class AAEncryption
    {
        ...
        private static readonly string encryptionKey = "qahwws329mle9hf0ih3tl0hb3agk298h";
        ...
        public static string Encrypt(string gameData)
        {
            ...
            CryptoStream cryptoStream = new((Stream)memoryStream, cryptoTransform, CryptoStreamMode.Write);
        ...
        public static string Decrypt(string encryptedGameData)
        {
            ...
            CryptoStream cryptoStream = new((Stream)memoryStream, cryptoTransform, CryptoStreamMode.Read);
